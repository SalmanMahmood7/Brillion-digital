...
const TrustElements = () => {
  const stats = [
    { number: "500+", label: "Projects Delivered", icon: CheckCircle, color: "from-[#1e3a8a] to-[#1e40af]" },
    { number: "50+", label: "Enterprise Clients", icon: Users, color: "from-orange-500 to-orange-600" },
    { number: "99.9%", label: "Uptime Guarantee", icon: TrendingUp, color: "from-[#1e3a8a] to-orange-500" },
    { number: "24/7", label: "Support Available", icon: Zap, color: "from-orange-500 to-[#1e3a8a]" },
  ];

  const certifications = [
    { name: "ISO 27001", description: "Information Security", icon: Shield, color: "from-[#1e3a8a] to-[#1e40af]" },
    { name: "Microsoft Gold", description: "Certified Partner", icon: Award, color: "from-orange-500 to-orange-600" },
    { name: "SOC 2 Type II", description: "Security Compliance", icon: CheckCircle, color: "from-[#1e3a8a] to-orange-500" },
    { name: "PIPEDA", description: "Privacy Compliant", icon: Shield, color: "from-orange-500 to-[#1e3a8a]" },
  ];
