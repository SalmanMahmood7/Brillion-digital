...
import { Shield, CheckCircle, ArrowRight, Lock, Eye, AlertTriangle, Users, Database, Settings } from "lucide-react";
...
export default function CyberSecurity() {
  ...
  useEffect(() => {
    const fetchServiceData = async () => {
      try {
        const data = await detailedServicesService.getBySlug('cyber-security');
        setServiceData(data);
      } catch (error) {
          ...
          <div className="container mx-auto px-6 lg:px-12 max-w-7xl">
            ...
            <div className="text-center mt-20">
              <div className="bg-gradient-to-r from-blue-600 to-blue-600 rounded-3xl p-12 text-white">
                {(() => {
                  const CtaIconComponent = iconMap[serviceData.ctaIcon as keyof typeof iconMap] || Shield;
