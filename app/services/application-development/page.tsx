...
import { Code, CheckCircle, ArrowRight, Smartphone, Globe, Database, Cloud, RefreshCw, GitBranch } from "lucide-react";
...
export default function ApplicationDevelopment() {
  ...
  useEffect(() => {
    const fetchServiceData = async () => {
      try {
        const data = await detailedServicesService.getBySlug('application-development');
        setServiceData(data);
      } catch (error) {
          ...
          <div className="container mx-auto px-6 lg:px-12 max-w-7xl">
            ...
            <div className="text-center mt-20">
              <div className="bg-gradient-to-r from-blue-600 to-blue-600 rounded-3xl p-12 text-white">
                {(() => {
                  const CtaIconComponent = iconMap[serviceData.ctaIcon as keyof typeof iconMap] || Code;
