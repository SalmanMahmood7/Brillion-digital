  ...
  return (
    <PageLayout>
      <div className="min-h-screen bg-white">
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 container mx-auto px-6 lg:px-12 1366:px-8 max-w-6xl 1366:max-w-5xl">
            <div className="text-center space-y-6">
              <h1 className="text-6xl md:text-7xl lg:text-8xl 1366:text-7xl font-bold text-white mb-6">
                <span className="text-[#f97316]">Dynamics 365</span> and <br />
        ...
        <section className="pt-8 1366:pt-6 pb-8 1366:pb-6">
                ...
                <div className="bg-white/60 backdrop-blur-sm border-l-4 border-teal-500 p-6 rounded-lg shadow-lg border border-gray-100/50">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <div className="text-[#1e3a8a] text-sm leading-relaxed mb-3">
                      ...
                      <div className="text-xs text-[#1e3a8a] italic font-medium text-right">
          ...
          <div className="container mx-auto px-6 lg:px-12 max-w-7xl">
            ...
            <div className="text-center mb-10">
              <div className="inline-block mb-4">
                <span className="text-lg font-semibold text-orange-500 uppercase tracking-wider">Benefits</span>
              </div>
              <h2 className="text-3xl md:text-4xl font-bold text-[#1e3a8a] max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
              ...
              <div className="text-center bg-white/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-100/50">
                ...
                <h3 className="text-lg font-bold text-[#1e3a8a] mb-3">Rapid Deployment</h3>
              ...
              <div className="text-center bg-white/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-100/50">
                ...
                <h3 className="text-lg font-bold text-[#1e3a8a] mb-3">Cost Reduction</h3>
                <p className="text-gray-600 text-sm">
              ...
              <div className="text-center bg-white/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-100/50">
                ...
                <h3 className="text-lg font-bold text-[#1e3a8a] mb-3">Better Insights</h3>
                <p className="text-gray-600 text-sm">
              ...
              <div className="text-center bg-white/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-100/50">
                ...
                <h3 className="text-lg font-bold text-[#1e3a8a] mb-3">Innovation</h3>
                <p className="text-gray-600 text-sm">
        ...
        <section className="pt-8 pb-8 1366:pt-8 1366:pb-8">
          <div className="container mx-auto px-6 lg:px-12 max-w-7xl">
              ...
              <div className="group bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100/50">
                ...
                >
                  <div className="flex items-center">
                    ...
                    <h3 className="text-2xl font-bold text-[#1e3a8a]">Microsoft Dynamics 365</h3>
                  </div>
                  <ChevronDown className={`w-6 h-6 text-[#1e3a8a] transition-transform duration-300 ${expandedCard === 'dynamics365' ? 'rotate-180' : ''}`} />
                </div>
                ...
                {expandedCard === 'dynamics365' && (
                  <div className="px-8 pb-8 animate-in slide-in-from-top duration-300">
                    <div className="border-l-4 border-orange-500 pl-6 mb-8">
                      <p className="text-[#1e3a8a] leading-relaxed text-base">
              ...
              <div className="group bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100/50">
                ...
                >
                  <div className="flex items-center">
                    ...
                    <h3 className="text-2xl font-bold text-[#1e3a8a]">Modern Workplace</h3>
                  </div>
                  <ChevronDown className={`w-6 h-6 text-[#1e3a8a] transition-transform duration-300 ${expandedCard === 'workplace' ? 'rotate-180' : ''}`} />
                </div>
                
                {expandedCard === 'workplace' && (
                  <div className="px-8 pb-8 animate-in slide-in-from-top duration-300">
                    <ul className="space-y-4 text-[#1e3a8a] mb-6">
                      <li className="flex items-start">
                        <CheckCircle className="w-5 h-5 text-orange-500 mr-3 mt-0.5 flex-shrink-0" />
                        <span className="text-base">Implement and roll out MS Teams for Collaboration</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-5 h-5 text-orange-500 mr-3 mt-0.5 flex-shrink-0" />
                        <span className="text-base">Enterprise Mobility and Security (MDM, MAM, Intune, AIP and RMS)</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-5 h-5 text-orange-500 mr-3 mt-0.5 flex-shrink-0" />
                        <span className="text-base">Directory Synchronization</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-5 h-5 text-orange-500 mr-3 mt-0.5 flex-shrink-0" />
                        <span className="text-base">Hybrid Deployments</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-5 h-5 text-orange-500 mr-3 mt-0.5 flex-shrink-0" />
                        <span className="text-base">Azure Storage accounts for Backups and Recovery</span>
                      </li>
                    </ul>
              ...
              <div className="group bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100/50">
                ...
                >
                  <div className="flex items-center">
                    ...
                    <h3 className="text-2xl font-bold text-[#1e3a8a]">Business Applications</h3>
                  </div>
                  <ChevronDown className={`w-6 h-6 text-[#1e3a8a] transition-transform duration-300 ${expandedCard === 'business' ? 'rotate-180' : ''}`} />
                </div>
              ...
              <div className="group bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100/50">
                ...
                >
                  <div className="flex items-center">
                    ...
                    <h3 className="text-2xl font-bold text-[#1e3a8a]">Migration to Azure Cloud</h3>
                  </div>
                  <ChevronDown className={`w-6 h-6 text-[#1e3a8a] transition-transform duration-300 ${expandedCard === 'azure' ? 'rotate-180' : ''}`} />
                </div>
        ...
        <section id="solutions" className="pt-8 pb-8 1366:pt-8 1366:pb-8">
          <div className="container mx-auto px-6 lg:px-12 max-w-7xl">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-[#1e3a8a] max-w-4xl mx-auto">
              ...
              <div className="group relative bg-white/60 backdrop-blur-sm rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100/50 hover:border-orange-200">
                ...
                >
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-[#1e3a8a] mb-2">Property Management</h3>
              ...
              <div className="group relative bg-white/60 backdrop-blur-sm rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100/50 hover:border-orange-200">
                ...
                >
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-[#1e3a8a] mb-2">Food Service</h3>
                      <p className="text-orange-600 font-semibold">View Document</p>
                    </div>
                  </div>
                </a>
              ...
              <div className="group relative bg-white/60 backdrop-blur-sm rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100/50 hover:border-orange-200">
                ...
                >
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-[#1e3a8a] mb-2">Education</h3>
                      <p className="text-orange-600 font-semibold">View Document</p>
                    </div>
                  </div>
                </a>
              ...
              <div className="group relative bg-white/60 backdrop-blur-sm rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100/50 hover:border-orange-200">
                ...
                >
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-[#1e3a8a] mb-2">Oil & Gas</h3>
                      <p className="text-orange-600 font-semibold">View Document</p>
                    </div>
                  </div>
                </a>
              ...
              <div className="group relative bg-white/60 backdrop-blur-sm rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100/50 hover:border-orange-200">
                ...
                >
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-[#1e3a8a] mb-2">Finance</h3>
                      <p className="text-orange-600 font-semibold">View Document</p>
                    </div>
                  </div>
                </a>
              ...
              <div className="group relative bg-white/60 backdrop-blur-sm rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100/50 hover:border-orange-200">
                ...
                >
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-[#1e3a8a] mb-2">Insurance</h3>
                      <p className="text-orange-600 font-semibold">View Document</p>
                    </div>
                  </div>
                </a>
            ...
            <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
              ...
              {/* Diligent Support */}
              <div className="bg-[#1e3a8a] rounded-3xl p-8 text-white shadow-xl">
                <div className="flex items-center mb-6">
              ...
              <div className="rounded-3xl p-8 text-white shadow-xl" style={{backgroundColor: '#f97316'}}>
                <div className="flex items-center mb-6">
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center mr-4" style={{backgroundColor: '#1e3a8a'}}>
        ...
        {/* FAQ Section */}
        <section className="pt-8 pb-8 sm:pt-8 sm:pb-8 lg:pt-8 lg:pb-8 relative">
          {/* Background Elements */}
          <div className="absolute inset-0">
          ...
          <div className="relative z-10 container mx-auto px-6 lg:px-12 1366:px-8 max-w-6xl 1366:max-w-5xl">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-left">
                ...
                <p className="text-white/90 mb-6 text-lg leading-relaxed max-w-3xl">
