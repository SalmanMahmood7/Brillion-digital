          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                {connectionStatus === 'connecting' && <Loader2 className="h-4 w-4 animate-spin text-[#1e3a8a]" />}
          ...
          <CardContent>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="text-2xl font-bold text-[#1e3a8a]">{totalDocuments}</div>
                ...
                <CardHeader className="pb-3">
                  <CardTitle className="flex items-center gap-3 text-lg">
                    <div className="p-2 bg-blue-100 rounded-lg">
                      <IconComponent className="h-5 w-5 text-[#1e3a8a]" />
                    </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              >
                <div className="font-medium text-[#1e3a8a]">Firestore Database</div>
                <div className="text-sm text-[#1e3a8a]">View all collections and documents</div>
              </a>
