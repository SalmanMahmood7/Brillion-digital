  ...
  return (
    <PageLayout>
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <div className="bg-white rounded-xl p-6 shadow-lg">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-blue-100 text-[#1e3a8a] rounded-full text-xs font-medium">AI/ML</span>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <span className="px-3 py-1 bg-blue-100 text-[#1e3a8a] rounded-full text-xs font-medium">Cloud</span>
        ...
        {/* Final CTA */}
        <section className="py-14 bg-gradient-to-r from-blue-600 to-[#f97316]">
