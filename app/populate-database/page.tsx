    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto px-6 max-w-4xl">
                ...
                <div className="space-y-2">
                  {Object.entries(collections).map(([collection, count]) => (
                    <div key={collection} className="flex justify-between items-center p-2 bg-gray-50 rounded">
                      ...
                      <span className="text-sm bg-blue-100 text-[#1e3a8a] px-2 py-1 rounded">
                        {count} documents
                      </span>
                    </div>
                  ))}
        ...
        <div className="mt-8 grid md:grid-cols-2 gap-4">
          ...
          >
            <strong className="text-[#1e3a8a]">Firebase Console</strong>
            <p className="text-sm text-[#1e3a8a] mt-1">View database in Firebase Console</p>
          </a>
