...
export default function TestFirebasePage() {
  ...
  const getStatusIcon = () => {
    switch (status) {
      case 'testing':
        return <Database className="h-6 w-6 animate-pulse text-[#1e3a8a]" />;
      case 'success':
        ...
        <Card className="mt-6">
          ...
          <CardContent>
            <div className="space-y-2">
              ...
              >
                <strong className="text-[#1e3a8a]">Firestore Database</strong>
                <p className="text-sm text-[#1e3a8a]">View and manage your Firestore collections</p>
              </a>
